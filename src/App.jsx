...
export default function App() {
  ...
  const calculateResults = () => {
    ...
    // Calculate accuracy
    let correctChars = 0;
    const textLength = Math.min(text.length, targetText.length);
        ...
        <div className="container mx-auto px-4">
          <div className="flex justify-between items-center h-16">
            ...
            <div className="hidden md:flex items-center space-x-4">
              ...
              <button 
                className={`px-3 py-2 rounded-md transition-all duration-300 ${activeTab === "about" ? (darkMode ? "bg-purple-600" : "bg-purple-600") : (darkMode ? "hover:bg-gray-700" : "hover:bg-purple-700")}`}
  ...
  <h2 className={`text-2xl font-bold mb-6 ${darkMode ? "text-purple-400" : "text-purple-800"} flex items-center`}>
    ...
    Interactive Feature Showcase
      ...
      <footer className={`py-8 mt-12 ${darkMode ? "bg-gray-800 text-white" : "bg-gradient-to-r from-purple-800 to-indigo-900 text-white"} relative z-10`}>
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="flex space-x-6">
              <a href="#" className={`${darkMode ? "text-gray-400 hover:text-white" : "text-purple-200 hover:text-white"} transition-colors duration-300`}>
